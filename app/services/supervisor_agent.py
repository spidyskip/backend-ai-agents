...
class SupervisorAgent:
    ...
    def select_agent(
        ...
        """
        self.query_supervisor = "Return the agent id that is most qualified to handle the query."
        ...
        context_message += "\nList Agents:\n"
        context_message += "\n".join([f"{agent_id}: \n Categories: {agent['categories']} \n Keyword: {agent["keywords"]}" for agent_id, agent in agents.items()])
        ...
        agent_input["messages"].append({"role": "user", "content": self.query_supervisor})
